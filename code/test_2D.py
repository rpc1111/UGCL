...
def test_single_volume(case, net, test_save_path, FLAGS,i):
...
def Inference(FLAGS):
   ...
   # snapshot_path = "./model/ACDC/Mean_Teacher_3_labeled".format(FLAGS.exp, FLAGS.labelnum, FLAGS.stage_name)
    ...
    test_save_path = "../model/{}_{}_labeled/{}_6_predictions/".format(
        FLAGS.exp, FLAGS.labeled_num, FLAGS.model)
    ...
    for case in tqdm(image_list):
        first_metric, second_metric, third_metric = test_single_volume(case, net, test_save_path, FLAGS,i)
        i+=1
